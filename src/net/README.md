...
- **Coverage.** `scripts/e2e-multiplayer.mjs` grew two groups (this lane owns that script): a **crew-card round trip**
  ...
  `npm run typecheck` is clean for `src/net` + `src/pickups` and `npm run net:selftest` stays **194/194**.
