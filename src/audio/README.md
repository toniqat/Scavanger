...
- 2026-09-21 — Doc fixes (B-80 · B-81 · B-82): `thumper_thump` added to the sound-id table (the one id of 221 missing from it), `cappedVoices` documented as keyed by the **voice group** (2026-09-16 moved the cap there), and the `floor` note now states the criterion only — the enumeration of three had reached ten in the table.
