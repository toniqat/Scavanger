...
import type { CrewCardWire, GameContext, HubShipKind, Interactable, PeerId, RoomPurpose } from '@/shared';
import { NET_SLOT_COLORS, ROOM_PURPOSE_COLOR, ROOM_PURPOSE_LABEL_KO } from '@/shared';
