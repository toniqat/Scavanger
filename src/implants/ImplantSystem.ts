...
import {
  IMPLANT_BARRIER_BLOCK_DAMAGE, IMPLANT_BARRIER_CARRY_REGEN_DELAY, IMPLANT_OVERCHARGE_ENERGY,
  Keys, createBuffGuard, type BuffVerdict,
  type BuffMessage, type GameContext, type GameSystem, type ImplantDef, type ImplantId,
  type ImplantMessage, type ImplantsRef, type PeerId, type PlayerRef, type RelayTarget,
} from '@/shared';
...
import { OverchargeBeam } from './effects/Overcharge';
import { ImplantFx } from './fx/ImplantFx';
import { RemoteImplants } from './RemoteImplants';

import { BUMP_FX_INTERVAL, _bp, _d, _from, _hitPt, _hp, _muzzle, _n, _o, _p, _r, _t, _tmp } from './model';
