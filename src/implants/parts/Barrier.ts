...
import {
  ...
  Keys, MouseButtons, type EnemyRef, type ImplantDef, type PeerId, type RelayTarget,
} from '@/shared';
import { implantHex } from '../ImplantDefs';
import { BarrierField } from '../effects/Barrier';
import { ABSORB_RANGE, BARRIER_SEND_EVERY_HITS, BASH_FX_Y, BUMP_FX_INTERVAL, HUD_EMIT_INTERVAL, SHIELD_SPEED_KEY, _bp, _d, _from, _hitPt, _hp, _muzzle, _n, _o, _p, _r, _t, _tmp, tuple } from '../model';
