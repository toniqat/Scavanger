...
import {
  IMPLANT_BARRIER_CARRY_REGEN_DELAY, IMPLANT_BARRIER_HP, IMPLANT_OVERCHARGE_ENERGY,
  type ImplantId,
  type PlayerRef,
} from '@/shared';
import { IMPLANT_DEFS, isImplantId } from '../ImplantDefs';
import { ImplantDevice } from '../devices/ImplantDevice';
import { type Host, _bp, _d, _from, _hitPt, _hp, _muzzle, _n, _o, _p, _r, _t, _tmp } from '../model';
