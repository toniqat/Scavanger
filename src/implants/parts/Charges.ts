...
import {
  IMPLANT_OVERCHARGE_ENERGY,
  IMPLANT_OVERCHARGE_REGEN_TIME, type ImplantDef, type ImplantId,
} from '@/shared';
import { HUD_EMIT_INTERVAL, _bp, _d, _from, _hitPt, _hp, _muzzle, _n, _o, _p, _r, _t, _tmp } from '../model';
