...
- **2026-09-09 (탈출 신호소 빛기둥)** — `Console.ts` 의 40 m 홀로그램 빛기둥이 **평상시(idle)에는 꺼진다**.
  ...
  (`active`, 호박색 점멸)에는 **그대로 켜진다** — 이미 분대 전원이 아는 사실이고 120초 카운트다운의
