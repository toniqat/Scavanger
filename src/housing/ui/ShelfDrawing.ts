 ...
 *
 * - 책장 = 나무 틀 + 선반 4단 × 2칸, 꽂힌 칸 = 시리즈 색 **책등**(글리프 + 세로쓰기 시리즈 이름)
 * - 디스크 전시대 = 금속 틀 + 아크릴 턱 3단 × 2칸, 꽂힌 칸 = **디스크 케이스**(색 디스크 · 띠)
 * - 레코드랙 = 검은 랙 2단 × 2칸, 꽂힌 칸 = **레코드 슬리브**(뒤로 삐져나온 LP)
 * - 게임 디스크 전시대 (2026-09-13) = 짙은 남색 틀 3단 × 2칸, 꽂힌 칸 = 윗단이 디스크 테마 색인 **게임 케이스**
 *
...
/** Slots per shelf row in every 서재 보관함 (책장 4 × 2 · 디스크 전시대 3 × 2 · 레코드랙 2 × 2 · 게임 디스크 전시대 3 × 2). */
