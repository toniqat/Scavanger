...
import {
  ENEMY_SHOT_ALERT_DIST, ENEMY_SHOT_IMPACT_DIST, GADGET_LURE_RADIUS, ROGUE_RANGE, type PeerId, type ShotReport,
} from '@/shared';
import { Enemy } from '../Enemy';
import { ROGUE_AI, isWormType } from '../EnemyTypes';
import { CombatTarget, type TargetId } from '../Targets';
import { SUSPICION_TIME } from '../ai/EnemyAI';
...
import {
  CLASH_RADIUS, CLASH_THROTTLE, GUNFIRE_LURE_DURATION, GUNFIRE_LURE_WEIGHT, MAX_SHOT_RANGE, SHOT_CHECK_INTERVAL, SUSPICION_RADIUS, SUSPICION_REFRESH, _aim, _c, _dir, _eye, _hc, _hd, _hp, _kb, _m, _sd,
  _sh, _so, _to, _v, _v2, _zero, isVec3Tuple,
} from '../model';
