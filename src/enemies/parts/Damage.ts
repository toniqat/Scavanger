...
import {
  BEHEMOTH_KNOCKBACK, PLAYER_HEIGHT, PLAYER_RADIUS, ENEMY_GRENADE_KINDS, blastReachesBody, explosionFalloff, meleeReachesBody, type CorpseLootOpts, type DamageMessage, type EnemyEvent,
  type EnemyFaction, type EnemyType, type HitRequest, type PeerId,
} from '@/shared';
import { Enemy, type HitPart } from '../Enemy';
import { ENEMY_CLASH, baseTypeOf, isWormType, raidXpOf } from '../EnemyTypes';
import { CombatTarget, type TargetId } from '../Targets';
import { becomeAlert } from '../ai/Perception';
import { endInvestigation } from '../ai/Investigate';
import type { AcidSlow } from '../fx/AcidProjectile';
import { round, tuple } from '../net/HostSync';
import { rollCorpseLootable, type CorpseWireOpts } from '../Corpses';
import { namedBodyCenterY } from '../models/named';
import {
  BARRIER_BUMP_INTERVAL, BARRIER_RETARGET_S, MAX_REQUEST_DAMAGE, MAX_REQUEST_KNOCKBACK, MAX_REQUEST_RADIUS, SHIELD_CONTACT_Y, _aim, _c, _dir, _eye, _hc, _hd, _hp, _kb, _m, _sd, _sh, _so, _to, _v, _v2,
  _zero, deathDirIndex, isVec3Tuple, killedBuf,
} from '../model';
