 ...
 *   수류탄은 `GRENADE_RADIUS` 7.2 m 안이어야 `EXPLOSION_OUTER_MUL` × `GRENADE_DAMAGE` ≥ 튜토리얼 안드로이드 체력이다
 *   (2026-09-17 전면 1/3 재조정: 0.5 × 60 = 30 ≥ 체력 30 — `enemies.csv` `tut_android*`. 옛 값 0.6 × 250 = 150 > 140). 두 대가 s 만큼 떨어져
 ...
 *     터져도** 둘 다 7.2 m 안이라 30 피해 ≥ 체력 30 이다 (2026-09-17 — 옛 150 > 140).
