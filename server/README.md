...
## 암호화폐 시세 (2026-09-13, docs/plans/power-crypto.md)
...
## 단체 메신저방 (2026-09-14, docs/plans/messenger-quests.md §4)
...
- **2026-09-14 (단체 메신저방 · 개인 대화, 에이전트 A — docs/plans/messenger-quests.md)** — 새 파일 `Rooms.ts` (위 `단체 메신저방` 절). `RelayServer.ts`: `room:*` 파서
...
- **2026-09-13 (암호화폐 시세 · 매매 검증, 에이전트 ⑤ — docs/plans/power-crypto.md)** — 위 `암호화폐 시세` 절이 전부다. 새 파일 `CryptoMarket.ts`.
