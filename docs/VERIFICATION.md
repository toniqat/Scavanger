...
- 2026-09-14 총기 밸런스 · 모든 총알 발사체 · 툴팁 고정 · 대시 벽 판정 · 벌레 난이도 (`src/shared/{types,events,constants}.ts` **추가만** ·
  ...
  HEAD 워크트리에 재적용해 검증했다):
  - `npm run verify:all` (12 min 43 s) — 2 failed: `smoke-humanoid-ai` 37/39 (측면 우회 각도 — 41차에도 부하 중 같은 흔들림) ·
    `smoke-progression` 47/48 (`timeout waiting for boot`). `--only` 재실행은 둘 다 통과 (smoke-progression 262/262 · smoke-humanoid-ai 39/39).
  - docs line: 2026-09-14: typecheck ok, typecheck-server ok, net-selftest 522/522, data-check ok, build 3,891.31 kB JS / 392.19 kB CSS, smoke-ballistics 39/39, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 147/147, smoke-phase3 41/41, smoke-stratagems 75/75, smoke-drone-scan 24/24, smoke-phase4 58/58, smoke-ship-rooms 77/77, smoke-tactical 119/119, smoke-controls-hub 153/153, smoke-inventory-p6 183/183, smoke-console 63/63, smoke-loadout 69/69, smoke-search 77/77, smoke-housing 324/324, smoke-ui-p6 91/91, smoke-ui-p5 142/142, smoke-uniques 72/72, smoke-progression 47/48, smoke-rogue-v2 52/52, smoke-faction-sites 263/263, smoke-enemy-alert 42/42, smoke-resume-gate 62/62, smoke-meta 198/198, smoke-rogue-drop 48/48, smoke-favorite-chips 52/52, smoke-recovery-contract 43/43, smoke-humanoid-ai 37/39, smoke-ladder 38/38, smoke-training 108/108, smoke-ghost 86/86, smoke-pose 144/144, smoke-library 84/84, smoke-tv-games 29/29, smoke-aim-sway 25/25, smoke-furniture-access 49/49, smoke-stations 98/98, smoke-food-chain 83/83, smoke-generator 49/49, smoke-mining 64/64, smoke-favorites 45/45, smoke-library-consumers 37/37, smoke-tip-pin 50/50, smoke-video-games 75/75, smoke-gym 66/66, smoke-extraction 36/36, smoke-mining-ui 69/69, smoke-cooking 114/114, smoke-buffs 42/42, smoke-raidflow 89/89, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-consumables 36/36, smoke-ecology 119/119, smoke-social 209/209, smoke-props-collision 53/53, smoke-structure-reach 331/331, smoke-site-spawns 241/241, smoke-server-dist 36/36, smoke-structures 137/137, smoke-tutorial 88/88, smoke-hazard 57/57, smoke-pitch 162/162, smoke-named 44/44, smoke-burrow 22/22, smoke-tram-ride 26/26, smoke-rover 30/30, smoke-lights 30/30, smoke-sandworm 41/41, smoke-trust 66/66, smoke-netlink 48/48, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 175/175
...
- 2026-09-13 (40차) 가구 접근 면 배치 규칙 · 발전기 전력 · 암호화폐 채굴 / 거래소 (`src/shared/{crypto,cryptoMarket}.ts` 신규 · `src/shared/{housing,credits,net,events,meta,index}.ts` **추가만** ·
  ...
  - `npm run verify` (변경 폴더 전부): 1 failed → `smoke-meta` 197/198 **스모크 결함**(헬릭스 퀘스트 네 줄 가정 — `hx_crypto` 추가) → 기대값 수정 후 198/198.
  - docs line: 2026-09-13: typecheck ok, typecheck-server ok, net-selftest 522/522, data-check ok, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 147/147, smoke-phase3 41/41, smoke-stratagems 75/75, smoke-drone-scan 24/24, smoke-phase4 58/58, smoke-ship-rooms 77/77, smoke-tactical 115/115, smoke-inventory-p6 183/183, smoke-controls-hub 153/153, smoke-loadout 69/69, smoke-console 63/63, smoke-housing 300/300, smoke-search 77/77, smoke-ui-p6 91/91, smoke-progression 237/237, smoke-ui-p5 142/142, smoke-uniques 72/72, smoke-enemy-alert 42/42, smoke-rogue-v2 52/52, smoke-faction-sites 263/263, smoke-resume-gate 62/62, smoke-favorite-chips 52/52, smoke-meta 198/198 (재실행), smoke-recovery-contract 43/43, smoke-humanoid-ai 39/39, smoke-rogue-drop 48/48, smoke-training 108/108, smoke-ladder 38/38, smoke-ghost 86/86, smoke-pose 144/144, smoke-aim-sway 25/25, smoke-library 205/205, smoke-stations 98/98, smoke-furniture-access 49/49, smoke-food-chain 79/79, smoke-power 44/44, smoke-mining 61/61, smoke-favorites 45/45, smoke-gym 64/64, smoke-cooking 92/92, smoke-mining-ui 67/67, smoke-buffs 41/41, smoke-extraction 36/36, smoke-enemy-delta 66/66, smoke-consumables 36/36, smoke-planets 86/86, smoke-raidflow 89/89, smoke-ecology 103/103, smoke-props-collision 53/53, smoke-social 209/209, smoke-structure-reach 331/331, smoke-site-spawns 241/241, smoke-server-dist 36/36, smoke-structures 137/137, smoke-tutorial 86/86, smoke-hazard 57/57, smoke-pitch 162/162, smoke-named 44/44, smoke-burrow 22/22, smoke-tram-ride 26/26, smoke-rover 30/30, smoke-lights 30/30, smoke-sandworm 41/41, smoke-trust 66/66, smoke-netlink 48/48, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 175/175 (11 min 56 s)
  - 수동으로 보지 않은 것: 실제 GPU 화면에서 클러스터 · 메인 컴퓨터 모델의 가독성(헤드리스 스크린샷에서 어두운 몸체가 잘 안 읽혔다) · 오래 켜 둔 릴레이의 시세 곡선 · 사람 손으로 한 전력 할당 조작감.
...
- 2026-09-13 (37차) 요리 미니게임 · 요리 품질 · 주방 자동 조리 가구 (`src/shared/cooking.ts` 신규 · `src/shared/{types,housing,progression,events,net,charBuffs,index}.ts` **추가만** ·
  ...
  ① 에이전트 실행(전용 vite 5311–5315 · 공용 릴레이): `smoke-cooking` 92/92 · `smoke-inventory-p6` 183/183 · `smoke-progression` 237/237 · `smoke-pose` 144/144 · `smoke-housing` 300/300 ·
  `smoke-lights` 30/30 · `smoke-console` 63/63 · `smoke-buffs` 41/41. 요리 툴팁 · 버프 · 토스트 · SFX 는 일회용 헤드리스 검사 40/41(나머지 1건은 검사 자체의 결함).
  ② 리드 `node scripts/verify.mjs --only smoke-cooking,smoke-inventory-p6,smoke-progression,smoke-pose,smoke-housing,smoke-lights,smoke-stations,smoke-gym,smoke-buffs,smoke-console,smoke-meta --keep-relay --log-dir scripts/logs/cooking`
  — **all passed, 2 min 13 s** (남은 에이전트 vite 5314 를 끄고 돌렸다).
  `docs line: 2026-09-13: typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, smoke-cooking 92/92, smoke-progression 237/237, smoke-inventory-p6 183/183, smoke-stations 98/98, smoke-housing 300/300, smoke-gym 64/64, smoke-pose 144/144, smoke-buffs 41/41, smoke-console 63/63, smoke-meta 198/198, smoke-lights 30/30`
  확인 못 한 것: `verify:all` · `e2e:mp`(식탁 품질 와이어) · 미니게임 화면 · 조리대 카메라 · 가구 모델 · SFX 는 눈 · 귀로 안 봤다.
- 2026-09-13 (36차) 행성별 적 난이도 — 안드로이드 · 로그 · 레이더 (`src/shared/{types,net,planetDefs,meta}.ts` **추가만** · `data/{enemies,enemy_abilities,tables,planets,loot_corpses,loot_corpse_rolls,contracts}.csv` +
  `loot_factions.csv` · `loot_faction_sites.csv` 신규 · `src/{enemies,items,world,meta,audio,ui}` · 스모크 신규 3종(`smoke-site-spawns` · `smoke-faction-sites` · `smoke-humanoid-ai`) + 도구 `shots-factions`,
  **에이전트 5개 병렬 + 리드**, 같은 트리에서 다른 세션 둘(지하벌레 · 요리 미니게임)이 동시 작업):

  ① 에이전트 실행(각자 전용 vite 5301–5305 · 공용 릴레이): `smoke-site-spawns` 253/253 · `smoke-structure-reach` 302/302 · `smoke-humanoid-ai` 39/39 · `smoke-rogue-v2` 52/52 ·
  `smoke-enemy-alert` 42/42 · `smoke-enemy-delta` 66/66 · `smoke-named` 44/44 · `smoke-faction-sites` 263/263 · `smoke-rogue-drop` 48/48 · `smoke-ecology` 103/103 · `smoke-raidflow` 89/89 ·
  `smoke-lights` 30/30 · `smoke-meta` 198/198. 전리품: 팩션마다 5 000 시체 굴림 — 명세 분포와 허용 오차 안, 벌레 · 로그 분대장 · 네임드는 400 시드 × 행성 6 해시가 전후 동일.
  ② 리드 `node scripts/verify.mjs --folders enemies,items,world,meta,ui,audio,gadgets,inventory --keep-relay --jobs 3 --log-dir scripts/logs/lead-factions` — **7 failed, 11 min 44 s**.
  이 작업이 아닌 것: `smoke-housing` 291/292 · `smoke-uniques` 71/72(`normalizeMealQuality` 미정의) · `smoke-inventory-p6` 158/159(조리대 목록) = 요리 세션 진행 중, `smoke-burrow` 21/22 = 지하벌레 세션(그쪽에서 스모크 결함으로 고침).
  `smoke-phase4` 56/58 = C-14 재해 구역 적 피해(지하벌레 세션의 `HazardRef.damageMul`) · C-24 곡사포 좌우 핑퐁(곡사포 AI 는 이번에 안 건드렸다). `smoke-phase3` 18/20 = 보급 구조물 착지점 12 m 안에
  `destructible` 이 7개(구조물 5 + 다른 것 2)라 첫 `destructible` 이 `hp` 없는 물체다 — `destructible` 코드는 작업 트리 변경 0 이라 **맵 배치가 바뀐 탓으로 추정**(같은 날 탈출 패드 수 · 포자 배치가 바뀌었다), 확인은 안 했다.
  `smoke-faction-sites` 255/263 = 스모크를 인원 후속 결정(폐허 · 플랫폼 그룹 2–3명)에 먼저 맞춘 탓.
  ③ 인원 후속 결정 반영 뒤 `node scripts/verify.mjs --only smoke-faction-sites,smoke-phase3,smoke-phase4 --keep-relay --jobs 2 --log-dir scripts/logs/lead-factions2` →
  `smoke-faction-sites` **263/263** (15맵 시작 인간형: threat 1 12–18 · threat 2–3 19–27명, 옛 39–44), `smoke-phase3` · `smoke-phase4` 같은 실패. typecheck 빨강 28건은 전부 요리 세션의
  `hub/interiors/FurnitureKitchen.ts` · `housing/ui/cook/CookScreen.ts` (이 작업 파일은 0건).
  `docs line: 2026-09-13: typecheck exit 1 (동시 세션 요리), typecheck-server ok, net-selftest 480/480, data-check ok, smoke-faction-sites 263/263, smoke-humanoid-ai 39/39, smoke-site-spawns 269/269, smoke-rogue-drop 48/48, smoke-named 44/44, smoke-rogue-v2 52/52, smoke-enemy-alert 42/42, smoke-enemy-delta 66/66, smoke-ecology 103/103, smoke-raidflow 89/89, smoke-structure-reach 353/353, smoke-lights 30/30, smoke-meta 198/198, smoke-drone-scan 24/24, e2e-mp 175/175, smoke-phase3 18/20, smoke-phase4 56/58`

  ⚠ `src/shared` 를 건드렸고 `e2e:mp` 는 초록이지만 **`verify:all`(build 포함)은 돌리지 않았다** — 동시 세션이 typecheck 를 깨 둔 채다. 레이더 강하 두 번째 파도 · 분대 id 는 호스트 이관을 못 넘고,
  AI 체감(안드로이드의 둔함 · 로그 중거리 위협 · 레이더 우회조)은 스모크 수치로만 봤다 — **브라우저에서 손으로 싸워 본 것은 없다**.

- 2026-09-13 (35차-2) 버그 굴착 스폰 · 지하벌레 이벤트 (`src/enemies` · `src/audio` · `src/console` · `src/ui/hud/DangerIndicators.ts` · `data/{enemies,loot_corpses,constants,tables}.csv` ·
  스모크 신규 `smoke-burrow` · `smoke-sandworm` — 35차-1 커밋에서 분리하지 못해 32 · 34 · 36 · 37차와 한 커밋):

  ① `node scripts/verify.mjs --only smoke-extraction,smoke-hazard,smoke-burrow,smoke-sandworm,smoke-raidflow,smoke-lights --keep-relay --jobs 2 --log-dir scripts/logs/lead-d4`
  → smoke-burrow 21/22 = **스모크 결함**: 뱉어진 버그는 `stepSpatFlight` 가 착지점에 정확히 놓고 곧장 chase 로 달려 나가는데 착지 0.4 초 뒤에 거리를 쟀다(d 1.52) →
  `burrowLanded` 순간의 위치를 잡는다 → `--only smoke-burrow --no-typecheck` **22/22**. smoke-sandworm 41/41.
  ② 36차 리드 `verify --folders enemies,…` 에서 smoke-sandworm 41/41 · smoke-burrow 21/22(위 결함 수정 전 로그와 같은 줄).
  `docs line: 2026-09-13: smoke-burrow 22/22 (rerun), smoke-sandworm 41/41`

  ⚠ 지하벌레 리플리카 · 재접속 재동기화는 스모크의 단일 페이지 흉내까지만 봤고 **브라우저에서 손으로 해 본 것은 없다**.
...
- 2026-09-13 (32차) 기업 · 스테이션 · 서재 화면 카드 분리 · 작업대 목록 시설별 · 무한 상자 · 캐릭터 시트 확정 흐름 · 조종석 커스터마이징 · 재배 속도 · 배양조 · 배지 레시피 (`src/shared/{holdAsk(신규),types,progression,housing,constants,index}.ts` **추가만** · `data/{stats,skills,furniture,recipes,tuning,constants}.csv` · `src/{inventory,meta,progression,housing,hub,tutorial}` + `src/ui/hud/ShipManage.ts` · 스모크 8종, **에이전트 6개 병렬(같은 작업 트리 · 파일 소유 분리) + 리드**):

  ① 탐색 에이전트 4개 → `AskUserQuestion` 7라운드 → 결정이 끝난 묶음부터 구현 에이전트 6개. 각자 `npm run verify -- --log-dir scripts/logs/agent-<이름> --keep-relay`.
  ⚠ **병렬 러너끼리 공용 vite(5273)를 재사용하다 그것이 도중에 내려가** 한 번에 34 · 52건씩 `ERR_CONNECTION_REFUSED` red 가 났다 — 코드와 무관, 각자 `--rerun-failed` 로 green.
  진짜로 이 배치가 만든 red 는 **1종**: 새 능력치 · 숙련 툴팁이 `.item-tip` 클래스를 빌려 `#ui-root` 에 HUD 아이템 카드보다 먼저 붙어, `.item-tip` 을 찾던
  `smoke-controls-hub` · `smoke-housing` · `smoke-ui-p5` 가 숨은 툴팁을 집었다 → `.pg-tip*` 전용 클래스(「CSS 클래스 접두사는 폴더마다 달라야 한다」 그대로).
  ② 리드: 남은 vite/relay 없음 확인 후 `npm run verify:all` → **전부 green, 9분 38초** (로그의 `all passed` 줄로 확인).
  `docs line: 2026-09-13: typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, build 3,299.33 kB JS / 347.44 kB CSS, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 147/147, smoke-phase3 41/41, smoke-stratagems 75/75, smoke-drone-scan 24/24, smoke-phase4 60/60, smoke-ship-rooms 77/77, smoke-tactical 115/115, smoke-inventory-p6 159/159, smoke-controls-hub 153/153, smoke-loadout 69/69, smoke-console 63/63, smoke-housing 291/291, smoke-search 77/77, smoke-progression 202/202, smoke-ui-p6 91/91, smoke-ui-p5 142/142, smoke-enemy-alert 42/42, smoke-rogue-drop 30/30, smoke-uniques 72/72, smoke-resume-gate 62/62, smoke-meta 198/198, smoke-favorite-chips 52/52, smoke-rogue-v2 52/52, smoke-recovery-contract 43/43, smoke-ladder 38/38, smoke-training 108/108, smoke-ghost 86/86, smoke-pose 109/109, smoke-library 205/205, smoke-stations 65/65, smoke-gym 64/64, smoke-favorites 45/45, smoke-aim-sway 25/25, smoke-buffs 41/41, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-consumables 36/36, smoke-ecology 109/109, smoke-props-collision 53/53, smoke-social 209/209, smoke-raidflow 84/84, smoke-structure-reach 286/286, smoke-server-dist 36/36, smoke-tutorial 86/86, smoke-hazard 47/47, smoke-structures 144/144, smoke-pitch 162/162, smoke-named 39/39, smoke-tram-ride 26/26, smoke-lights 30/30, smoke-netlink 48/48, smoke-trust 66/66, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 175/175`

  ⚠ **브라우저에서 손으로 해 본 것은 아니다.** 선반 2D 그림 · 배양조 유리관 · 조종석 천장 페이드의 실제 모습, 40 px 기업 타일의 가독성, 캐릭터 툴팁 위치는 스모크가 구조 · 상태로만 확인했다.
...
- 2026-09-12 (25차) UI/UX 2차 대묶음 — 방 격자 2배 · 제작 UI 4열 · 기업 화면 분리 · 스테이션 격자 · 정비 벤치 은퇴 · 투척 거리 (`src/shared/{types,housing}.ts` **추가만**(+`refine` 라벨) · `data/{constants,armor,bags,tuning,furniture}.csv` · `src/{inventory,meta,housing,hub,items,audio,ui}` · 삭제 `src/hub/{Workbench.ts,ui/WorkbenchMenu.ts}` · 스모크 9종 기댓값, **에이전트 5개 병렬 + 리드**, 실패 정리에 에이전트 3개 추가):
  ...
  21건 중 **17건은 스모크의 오래된 기댓값**, **4건이 진짜 회귀**였다. 회귀 넷은 전부 이 배치가 새로 만든 것이고 셋은 사용자가 실제로 만나는 것이었다:
  - **스테이션 격자가 한쪽씩 화면 밖** (`smoke-stations`, 진짜 회귀) — `TradeGrids` 를 가로 2열로 바꾸면서 `.tg-scroll` 한 스크롤에 두 격자를 이어 붙였는데, 창고 24행 = 1381 px · 가방 틀 12행 = 709 px 이고 스크롤 창은 600 px 남짓이라 **창고가 위면 가방이 y≈1574, 가방이 위면 창고가 y≈900** 이다. 끌고 있는 동안에는 스크롤할 수 없으므로 1440×900 · 1536×864 같은 흔한 노트북에서 **수확물을 옮기는 길이 통째로 막혔다.** 순서 바꾸기(`order: -1`)는 문제를 옮길 뿐이라 되돌리고, `.hs-inv` 안에서만 **블록마다 자기 스크롤**로 갔다(`flex-wrap: nowrap` + `align-items: stretch`, 1600 px 미만은 세로로 `flex: 1 1 0` 반반). ⚠ **여러 줄 flex 에서 `stretch` 는 상자가 아니라 *그 줄*까지만 늘린다** — `nowrap` 이 없으면 아무 효과가 없다(실측으로 잡았다). 그리고 격자에 직접 `overflow-y` 를 걸면 **스크롤바가 마지막 열을 갉아먹는다**(`overflow-x: hidden` 이라 조용히 잘린다) → `.tg-gridwrap` 을 한 겹 넣고 `scrollbar-gutter: stable`. 이 환경은 오버레이 스크롤바 전용이라 **그냥 뒀으면 스모크가 절대 못 잡았을** 종류의 잘림이다. 다섯 폭(1280·1440·1536·1600·1920) 실측으로 확인.
  - **함선 인벤토리 창이 화면 밖으로 51 px** (`smoke-tutorial`, 진짜 회귀) — 「필터를 맨 위로」가 `.inv-root` 를 `justify-content: center` → `flex-start` + `padding-top: 74px` 로 바꿨는데 `.inv-bag-scroll` 의 예산 `calc(100vh - 430px)` 은 레이드의 8 px 여백 기준 그대로였다. 1280×760 에서 가방 패널이 top 76 → **bottom 811**(무게 바 · 가치 줄이 잘림). 함선 레이아웃만 차액 66 px 을 뺀다. 스포트라이트는 잘못이 없었고 **스모크가 화면 밖으로 나간 창을 잡은 것**이다.
  - **제작 창에 연 작업대가 목록에 없다** (`smoke-inventory-p6`, 진짜 회귀) — 새 작업대 리스트를 `getBenchLevel(kind) > 0` 으로만 만들어, 그 가구가 *내* `ctx.housing` 에 없으면(방문 함선 · 공유 함선) 제목은 `가공 작업대 Lv.3` 인데 **그 줄이 아예 없고 아무것도 선택되지 않았다.** 연 작업대는 항상 목록에 넣고 `max(설치 레벨, 연 레벨)` 을 쓴다.
  - **v1→v2 가 배치 불가능한 가구를 남긴다** (`smoke-housing`, 진짜 회귀) — 정비 벤치 은퇴 뒤에도 v1→v2 마이그레이션이 그것을 한 개 지급하는데, **은퇴 가구를 걷어내는 두 자리가 지급 줄보다 위**라 걸러지지 않고 가구 창고에 남아 목록에는 뜨고 배치는 안 됐다. 지급을 걷어냈다(이미 가진 세이브는 `sanitize` 가 환불).
  ③ 1차 정리 뒤 `verify:all` → **2 red**. 둘 다 위 스테이션 수정의 **뒷면**(가방을 위로 올렸더니 이번엔 창고가 화면 밖)과, 그 수정이 새로 깬 `smoke-quickslots` 였다. 후자는 **CSS 를 되돌리지 않는 것이 옳다고 판정** — 1280×760 함선에서 가방 6줄(336)을 다 보이게 하려면 `76 + 405 + 336 = 817 px` 이 필요한데 화면은 760 px 이라 「창이 화면 안에 든다」와 동시에 성립할 수 없고, 애초에 12줄 전설 가방(672)은 어떤 상수로도 안 들어간다(고정 틀 결정 자체가 「짧은 창에서는 가방이 스크롤한다」를 전제한다). 스모크의 `freeBagCell()` 이 좌표를 `y*56+27` 로 **계산**하고 스크롤 영역을 안 보던 것을 `scrollIntoView` + 실측으로 고쳤다.
  ④ 마지막 1 red 는 레이아웃이 **아니었다**: `hit: null` 의 범인은 **페이드 아웃 중인 타이틀 화면**이었다. `.menu` 의 `visibility` 전이는 *끝나는 순간*에야 `hidden` 이 되므로 `.hidden` 이 붙은 뒤에도 `--t-med` 동안 `inset: 0` · `pointer-events: auto` 로 살아 `elementFromPoint` 를 가져간다(실측: 280 ms 에도 visible, 601 ms 에야 hidden). 스모크는 347 ms 에 검사했다 — **사람이 도달할 수 없는 전이 상태**라 가드에 페이드 완료 대기를 넣었다. 같은 자리에서 **`.menu.hidden` 에 `pointer-events: none` 을 더했다**(`src/ui/styles/base.css`): 닫히는 중인 모든 메뉴가 300 ms 동안 투명한 채 클릭을 먹고 있었고, 타이틀에서 연타하면 보이지 않는 `게임 시작` 이 눌릴 수 있었다 — **이 배치 이전부터 있던 버그**다.
  ⑤ 플레이키 3종 확인: `smoke-library`(tier 4 책 굴림 0) · `smoke-phase3`(파괴 가능 소품 6 vs 5, 19차에 기록된 것과 같은 자리) · `smoke-rogue-v2`(두 번 **서로 다른** 검사가 실패 — 수류탄 빗나감 → 재장전 미개시) 전부 재실행 green. ⚠ 리드가 로그의 `11.17 m` 를 보고 이번 투척 거리 2배를 의심했으나 **`src/enemies/` 는 `GRENADE_THROW_SPEED` 를 쓰지 않는다** — 수치를 바꿨다고 해서 관련 없는 red 를 그 탓으로 돌리지 않는다.
  ⑥ 최종 `npm run verify:all` → **전부 green, 9분 44초**.
  `docs line: 2026-09-12: typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, build 3,046.39 kB JS / 307.68 kB CSS, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 133/133, smoke-phase3 33/33, smoke-stratagems 75/75, smoke-ship-rooms 72/72, smoke-tactical 91/91, smoke-phase4 60/60, smoke-controls-hub 153/153, smoke-loadout 69/69, smoke-inventory-p6 151/151, smoke-console 63/63, smoke-housing 293/293, smoke-progression 123/123, smoke-ui-p6 89/89, smoke-search 77/77, smoke-ui-p5 142/142, smoke-uniques 72/72, smoke-enemy-alert 42/42, smoke-rogue-drop 30/30, smoke-resume-gate 62/62, smoke-rogue-v2 52/52, smoke-training 114/114, smoke-meta 198/198, smoke-ladder 38/38, smoke-library 128/128, smoke-stations 61/61, smoke-ghost 86/86, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-ecology 109/109, smoke-social 209/209, smoke-props-collision 53/53, smoke-structure-reach 130/130, smoke-hazard 47/47, smoke-server-dist 36/36, smoke-structures 144/144, smoke-tutorial 86/86, smoke-raidflow 84/84, smoke-pitch 162/162, smoke-named 39/39, smoke-tram-ride 26/26, smoke-lights 30/30, smoke-netlink 48/48, smoke-trust 66/66, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 158/158`

  ⚠ **브라우저에서 손으로 해 본 것은 아니다.** 특히 **8×8 m 방의 실물**(방 10개가 겹치지 않고 서는지 · 구간 경계 벽에 z-fighting 이 없는지 · 네 구석이 읽히는지 · 시설 관리 카메라에 방이 다 들어오는지 · 문 앞으로 드나들 수 있는지)은 스모크가 좌표로만 확인했다. 새 눈 발소리도 **귀로 듣지 않았다** — 스펙트럼 근거로만 바꿨다.
...
- 2026-09-12 (헬스장 A-3a · 서재 매체 A-3e, `npm run verify:all`, 9 min 2 s, all passed — new `smoke-gym` · `smoke-pose`): typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, build 3,178.48 kB JS / 322.31 kB CSS, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 133/133, smoke-phase3 33/33, smoke-stratagems 75/75, smoke-ship-rooms 74/74, smoke-tactical 91/91, smoke-phase4 60/60, smoke-inventory-p6 151/151, smoke-controls-hub 153/153, smoke-loadout 69/69, smoke-housing 271/271, smoke-console 63/63, smoke-search 77/77, smoke-progression 170/170, smoke-ui-p6 91/91, smoke-ui-p5 142/142, smoke-uniques 72/72, smoke-enemy-alert 42/42, smoke-rogue-drop 30/30, smoke-rogue-v2 52/52, smoke-resume-gate 62/62, smoke-meta 198/198, smoke-training 108/108, smoke-ladder 38/38, smoke-pose 60/60, smoke-library 194/194, smoke-ghost 86/86, smoke-stations 61/61, smoke-gym 55/55, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-ecology 109/109, smoke-social 209/209, smoke-props-collision 53/53, smoke-structure-reach 130/130, smoke-hazard 47/47, smoke-server-dist 36/36, smoke-raidflow 84/84, smoke-tutorial 86/86, smoke-structures 144/144, smoke-named 39/39, smoke-pitch 162/162, smoke-tram-ride 26/26, smoke-lights 30/30, smoke-netlink 48/48, smoke-trust 66/66, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 158/158
- 2026-09-12 (캐릭터 버프 · 가구 자세 원격 동기화, `npm run verify:all`, 9 min 27 s, 49/50 — new `smoke-buffs`, extended `smoke-pose` · `smoke-housing` · `e2e-mp`; `smoke-phase3` timed out once under load ("timeout waiting for laser ended", 97 s) and passed 33/33 on `--rerun-failed`; that rerun's `data:check` failure (`WEAPON_MUZZLE_BLOCK_RANGE` 줄 없음) came from another session editing the same tree mid-run, not this change): typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, build 3,192.99 kB JS / 321.49 kB CSS, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 133/133, smoke-stratagems 75/75, smoke-phase4 60/60, smoke-tactical 91/91, smoke-phase3 27/28 → rerun 33/33, smoke-ship-rooms 74/74, smoke-inventory-p6 151/151, smoke-controls-hub 153/153, smoke-console 63/63, smoke-housing 284/284, smoke-loadout 69/69, smoke-progression 170/170, smoke-search 77/77, smoke-ui-p6 91/91, smoke-ui-p5 142/142, smoke-uniques 72/72, smoke-enemy-alert 42/42, smoke-rogue-drop 30/30, smoke-resume-gate 62/62, smoke-meta 198/198, smoke-training 108/108, smoke-ladder 38/38, smoke-rogue-v2 52/52, smoke-library 194/194, smoke-stations 61/61, smoke-ghost 86/86, smoke-gym 55/55, smoke-pose 109/109, smoke-buffs 41/41, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-ecology 109/109, smoke-props-collision 53/53, smoke-social 209/209, smoke-structure-reach 130/130, smoke-raidflow 84/84, smoke-server-dist 36/36, smoke-hazard 47/47, smoke-tutorial 86/86, smoke-structures 144/144, smoke-named 39/39, smoke-pitch 162/162, smoke-tram-ride 26/26, smoke-lights 30/30, smoke-netlink 48/48, smoke-trust 66/66, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 175/175
- 2026-09-12 (3인칭 에임 — 하이브리드 사격 판정 · 총구 막힘 표시 · 어깨 전환, `npm run verify:all`, 9 min 8 s, 51/53 — extended `smoke-weapons` (133 → 147: 15 m post not hit past the crosshair, 1.6 m post → marker + `weapon:aimBlocked` + `.reticle.blocked` + hit on the post, 5 m post no block, wall under the crosshair no warning, `services.aimShot` on the crosshair line, X shoulder swap) and `smoke-uniques` (rocket-jump failure now prints launch mode / origin / impact). **`smoke-uniques` 70/72 was a real bug**: the barrel check counted an enemy at the feet, so the air-burst rocket left horizontally from the body axis — fixed (barrel / line-start checks count walls only), `--only smoke-uniques,smoke-weapons` then 72/72 · 147/147. `smoke-rogue-drop` 29/30 ("절반 이상이 구조물 쪽으로") passed 30/30 on its own rerun — rogue AI timing, not this change. The `smoke-weapons` barrier-billing stub moved from 3 m along the body forward (off the shot line; terrain 2.7–2.9 m ahead won once shots stopped converging from the muzzle) to 1.2 m along the queried ray): typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, build 3,197.87 kB JS / 321.70 kB CSS, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 147/147, smoke-phase3 33/33, smoke-stratagems 75/75, smoke-ship-rooms 74/74, smoke-phase4 60/60, smoke-tactical 91/91, smoke-inventory-p6 151/151, smoke-controls-hub 153/153, smoke-loadout 69/69, smoke-console 63/63, smoke-housing 284/284, smoke-progression 170/170, smoke-search 77/77, smoke-ui-p6 91/91, smoke-ui-p5 142/142, smoke-uniques 70/72 → fix → 72/72, smoke-enemy-alert 42/42, smoke-rogue-drop 29/30 → rerun 30/30, smoke-rogue-v2 52/52, smoke-resume-gate 62/62, smoke-meta 198/198, smoke-training 108/108, smoke-ladder 38/38, smoke-library 194/194, smoke-ghost 86/86, smoke-stations 61/61, smoke-gym 55/55, smoke-pose 109/109, smoke-buffs 41/41, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-ecology 109/109, smoke-props-collision 53/53, smoke-social 209/209, smoke-structure-reach 130/130, smoke-raidflow 84/84, smoke-server-dist 36/36, smoke-hazard 47/47, smoke-tutorial 86/86, smoke-structures 144/144, smoke-pitch 162/162, smoke-named 39/39, smoke-tram-ride 26/26, smoke-lights 30/30, smoke-netlink 48/48, smoke-trust 66/66, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 175/175
- 2026-09-12 (30차: 전투 소모품 · 조준 흔들림 · 임플란트 준비 연출 · 갈고리 환급 · 소모형 열쇠 · 드론 스캔 · 즐겨찾기 · 헬스 미니게임 — 8 에이전트 병렬 + 리드 통합, `npm run verify:all`, 10 min 7 s, all passed — new `smoke-consumables` · `smoke-aim-sway` · `smoke-drone-scan` · `smoke-favorites` · `smoke-favorite-chips`, extended `smoke-tactical` (91 → 115) · `smoke-phase3` (33 → 41) · `smoke-structure-reach` (130 → 286) · `smoke-gym` (55 → 64, 입력 없이 실제 DOM 이 움직이는지) · `smoke-meta`. **`smoke-ladder` 36/36** 은 통과였지만 월드 천장 검사가 **건너뛰어진** 결과였다 — 가장 낮은 천장 후보가 새 연구소 잠긴 방 안이라 몸이 0.62 m 밀려났다; 후보를 낮은 순으로 차례로 시도하게 고쳐 `--only smoke-ladder` 38/38): typecheck ok, typecheck-server ok, net-selftest 480/480, data-check ok, build 3,258.22 kB JS / 332.24 kB CSS, smoke-quickslots 101/101, smoke-phase2 57/57, smoke-weapons 147/147, smoke-phase3 41/41, smoke-stratagems 75/75, smoke-drone-scan 24/24, smoke-phase4 60/60, smoke-ship-rooms 74/74, smoke-tactical 115/115, smoke-inventory-p6 151/151, smoke-controls-hub 153/153, smoke-loadout 69/69, smoke-console 63/63, smoke-housing 284/284, smoke-search 77/77, smoke-progression 170/170, smoke-ui-p6 91/91, smoke-ui-p5 142/142, smoke-enemy-alert 42/42, smoke-rogue-drop 30/30, smoke-uniques 72/72, smoke-rogue-v2 52/52, smoke-resume-gate 62/62, smoke-favorite-chips 50/50, smoke-meta 198/198, smoke-ladder 36/36 → fix → 38/38, smoke-training 108/108, smoke-ghost 86/86, smoke-pose 109/109, smoke-library 194/194, smoke-stations 61/61, smoke-favorites 45/45, smoke-gym 64/64, smoke-aim-sway 25/25, smoke-buffs 41/41, smoke-enemy-delta 66/66, smoke-planets 86/86, smoke-consumables 36/36, smoke-ecology 109/109, smoke-props-collision 53/53, smoke-social 209/209, smoke-raidflow 84/84, smoke-tutorial 86/86, smoke-server-dist 36/36, smoke-structure-reach 286/286, smoke-hazard 47/47, smoke-structures 144/144, smoke-pitch 162/162, smoke-named 39/39, smoke-tram-ride 26/26, smoke-lights 30/30, smoke-netlink 48/48, smoke-trust 66/66, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 175/175
...
### 2026-09-15 4차 — 편의성 · UI 대묶음 (가젯 개편 · 제작 UI · 창고+가방 통일 · 서재 3층 · 무게)

- 리드가 계약(`src/shared` · `constants.csv`)을 먼저 확정해 녹색 베이스라인을 만든 뒤 에이전트 6 병렬. 첫 `verify:all` 에서 8건 실패 →
  **진짜 버그 셋**(타입체크를 통과하는 자리): 수류탄 쿠킹 · 투척 사망(`weapons/model.quickKindOf`), 시작 퀵슬롯 수류탄 누락(`inventory/QuickSlots`),
  **`loot_category_weights.csv` 의 유령 `grenade` 카테고리가 상자를 13–23 % 확률로 통째로 잘랐다**(`items/LootTables` — 축 분리 + 이름 검증 + 후보 없는 카테고리는 재추첨).
  그리고 `housing/parts/Furniture.openShipManage` 에서 **기억한 방이 인자로 준 방을 이기던 것**(용도 카드 0장 → `smoke-housing` 5건의 뿌리). 나머지는 사용자 결정으로 낡은 단언.
- `smoke-ballistics` 의 히트마커 단언은 flake 였다(4회 중 1회) — `markers <= 2` 가 묶는 근거가 아니라 프레임 박자를 재고 있어 **`markers === steps`**(스텝마다 정확히 하나)로 바꿨다.
- 최종 `verify:all` 에서 `smoke-phase4 56/58` · `smoke-humanoid-ai 48/49` — **기존 flake 로 판정**: 두 스모크가 밟는 `src/enemies` · 시체 내구도 표 · 무기 수치가 이번 세션에
  실질적으로 무변경이고(`src/player` 의 `bypassShield` 갈래는 `opts` 가 없으면 옛 경로와 같다), 직렬 3회 재실행에서 원래 실패한 세 단언(시체 내구도 · C-24 좌우 · 레이더 명중)이
  **전부 통과**하고 매번 **다른** 단언이 떨어졌다(버그↔로그 피해 교환 2/3 · 로그 대 안드로이드 사격 수 1/3). 시체 내구도 단언은 절대값 `≤ 90` 인데 등급 II 기관단총은
  550 × 1.25 × 0.15 = **103** 까지 합법적으로 굴린다 — 단언 쪽 결함이다(이번 범위 밖이라 고치지 않았다).
- ⚠ 러너 함정: 「vite/relay already up」 으로 **죽는 중인** 앞 실행의 서버를 잡으면 `timeout waiting for boot` · `ERR_CONNECTION_REFUSED` 가 난다. 병렬 에이전트끼리 겹칠 때 여러 번 났다 — 부팅 타임아웃은 코드보다 **포트(5273 · 8787)를 먼저** 의심한다.
- docs line: 2026-09-15: typecheck ok, typecheck-server ok, net-selftest 583/583, data-check ok, build 4,239.00 kB JS / 449.93 kB CSS, smoke-ballistics 39/39, smoke-quickslots 109/109, smoke-phase2 57/57, smoke-weapons 147/147, smoke-phase3 41/41, smoke-stratagems 75/75, smoke-drone-scan 24/24, smoke-phase4 56/58, smoke-tactical 119/119, smoke-ship-rooms 77/77, smoke-controls-hub 154/154, smoke-search 77/77, smoke-inventory-p6 183/183, smoke-console 63/63, smoke-ui-p6 104/104, smoke-loadout 69/69, smoke-housing 324/324, smoke-ui-p5 141/141, smoke-progression 262/262, smoke-rogue-v2 52/52, smoke-uniques 99/99, smoke-faction-sites 263/263, smoke-enemy-alert 42/42, smoke-resume-gate 62/62, smoke-rogue-drop 48/48, smoke-meta 178/178, smoke-humanoid-ai 48/49, smoke-npc-quests 69/69, smoke-favorite-chips 52/52, smoke-recovery-contract 43/43, smoke-ladder 38/38, smoke-training 115/115, smoke-ghost 96/96, smoke-pose 144/144, smoke-aim-sway 25/25, smoke-tv-games 29/29, smoke-library 85/85, smoke-stations 98/98, smoke-furniture-access 49/49, smoke-food-chain 83/83, smoke-generator 48/48, smoke-mining 64/64, smoke-extraction 36/36, smoke-library-consumers 38/38, smoke-favorites 45/45, smoke-video-games 75/75, smoke-tip-pin 46/46, smoke-gym 66/66, smoke-mining-ui 70/70, smoke-raidflow 89/89, smoke-buffs 42/42, smoke-cooking 123/123, smoke-enemy-delta 66/66, smoke-consumables 36/36, smoke-rooms 37/37, smoke-messenger 70/70, smoke-planets 92/92, smoke-social 210/210, smoke-ecology 119/119, smoke-props-collision 53/53, smoke-site-spawns 517/517, smoke-structures 141/141, smoke-hazard 57/57, smoke-structure-reach 1035/1035, smoke-tutorial 91/91, smoke-tutorial-ship 55/55, smoke-fall-damage 101/101, smoke-server-dist 36/36, smoke-fire-zones 31/31, smoke-intel 16/16, smoke-tutorial-raid 61/61, smoke-intro-wake 30/30, smoke-named 44/44, smoke-pitch 162/162, smoke-burrow 22/22, smoke-tram-ride 26/26, smoke-rover 30/30, smoke-lights 30/30, smoke-map-quests 72/72, smoke-sandworm 41/41, smoke-netlink 48/48, smoke-trust 68/68, smoke-hangar 58/58, smoke-desktop 54/54, e2e-mp 178/178
- docs line: 2026-09-15: 직렬 재실행 3회 (flake 판정용) — smoke-phase4 57/58 · 58/58 · 57/58, smoke-humanoid-ai 49/49 · 48/49 · 49/49 (실패 단언이 매번 다르다)
