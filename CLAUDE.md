...
|---|---|---|---|
| [`data/`](data/README.md) | — | — | **게임 수치의 단일 원본 (csv 42개).** 데미지 · 체력 · 가격 · 확률 · 쿨다운 — `src/` 에는 같은 숫자가 없다 |
