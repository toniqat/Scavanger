...
개별 스모크 스크립트 47종의 목록과 각각이 검사하는 내용은 **[scripts/README.md](scripts/README.md)** 에 있다.
...
|---|---|---|---|
| [`data/`](data/README.md) | — | — | **게임 수치의 단일 원본 (csv 43개).** 데미지 · 체력 · 가격 · 확률 · 쿨다운 — `src/` 에는 같은 숫자가 없다 |
